...
module ValidatesZipcode
  module CldrRegexpCollection
    ZIPCODES_REGEX = {
      ...
      TT: /\A\d{6}\z/,
      TW: /\A\d{3}\z/,
      UK: /\AGIR[ ]?0AA|((AB|AL|B|BA|BB|BD|BH|BL|BN|BR|BS|BT|CA|CB|CF|CH|CM|CO|CR|CT|CV|CW|DA|DD|DE|DG|DH|DL|DN|DT|DY|E|EC|EH|EN|EX|FK|FY|G|GL|GY|GU|HA|HD|HG|HP|HR|HS|HU|HX|ID|IG|IM|IP|IV|JE|KA|KT|KW|KY|L|LA|LD|LE|LL|LN|LS|LU|M|ME|MK|ML|N|NE|NG|NN|NP|NR|NW|OL|OX|PA|PE|PH|PL|PO|PR|RG|RH|RM|S|SA|SE|SG|SK|SL|SM|SN|SO|SP|SR|SS|ST|SW|SY|TA|TD|TF|TN|TQ|TR|TS|TW|UB|W|WA|WC|WD|WF|WN|WR|WS|WV|YO|ZE)(\d[\dA-Z]?[ ]?\d[ABD-HJLN-UW-Z]{2}))|BFPO[ ]?\d{1,4}\z/, # Same as GB
      UG: /\A([a-zA-Z\d\s]){3,}\z/,
      UM: /\A([a-zA-Z\d\s]){3,}\z/,
      UY: /\A([a-zA-Z\d\s]){3,}\z/,
      VC: /\A(VC)\d{4}\z/,
